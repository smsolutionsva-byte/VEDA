...
- Expected-outcome accuracy: **39.79%**
- Auto-link precision: **87.76%**
- Auto-link coverage: **25.65%**
- UNSAFE auto-links on review/negative cases: **12**

## Category matrix
| Category | N | Retrieval Top1* | Pipeline outcome | Unsafe auto-links |
|---|---:|---:|---:|---:|
| ambiguity | 36 | N/A | 66.7% | 12 |
| asset_tags | 52 | 69.2% | 1.9% | 0 |
| graph | 44 | 100.0% | 72.7% | 0 |
| location | 44 | 72.7% | 34.1% | 0 |
| metadata | 40 | 100.0% | 50.0% | 0 |
| safety_reporting | 54 | 100.0% | 100.0% | 0 |
| temporal | 40 | 90.0% | 0.0% | 0 |
| terminology | 42 | 95.2% | 14.3% | 0 |
| wbs | 30 | 36.7% | 0.0% | 0 |
...
| OIL-HARD-0043 | asset_tags | tag_0 | match / 2000 | 1 | needs_review | None | False |
| OIL-HARD-0044 | asset_tags | tag_1 | match / 2200 | 1 | needs_review | None | False |
| OIL-HARD-0045 | asset_tags | tag_2 | match / 2400 | 1 | needs_review | None | False |
| OIL-HARD-0046 | asset_tags | tag_3 | match / 2600 | 2 | needs_review | None | False |

## Unsafe auto-links (must investigate)
- **OIL-HARD-0359** `multi_asset_single_evidence` → pipeline linked UID 13000 although expected `review`
- **OIL-HARD-0360** `multi_asset_single_evidence` → pipeline linked UID 13040 although expected `review`
- **OIL-HARD-0361** `multi_asset_single_evidence` → pipeline linked UID 13080 although expected `review`
- **OIL-HARD-0362** `multi_asset_single_evidence` → pipeline linked UID 13120 although expected `review`
- **OIL-HARD-0363** `multi_asset_single_evidence` → pipeline linked UID 13160 although expected `review`
- **OIL-HARD-0364** `multi_asset_single_evidence` → pipeline linked UID 13200 although expected `review`
- **OIL-HARD-0365** `multi_asset_single_evidence` → pipeline linked UID 13240 although expected `review`
- **OIL-HARD-0366** `multi_asset_single_evidence` → pipeline linked UID 13280 although expected `review`
- **OIL-HARD-0367** `multi_asset_single_evidence` → pipeline linked UID 13320 although expected `review`
- **OIL-HARD-0368** `multi_asset_single_evidence` → pipeline linked UID 13361 although expected `review`
- **OIL-HARD-0369** `multi_asset_single_evidence` → pipeline linked UID 13400 although expected `review`
- **OIL-HARD-0370** `multi_asset_single_evidence` → pipeline linked UID 13440 although expected `review`
